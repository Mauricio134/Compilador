...
enum TokenType {
    ...
    TOKEN_OPER_DIV, TOKEN_OPER_MOD, TOKEN_OPER_MENOR, TOKEN_OPER_MAYOR, TOKEN_OPER_MAY_E, TOKEN_OPER_MEN_E,
    ...
    TOKEN_IF,TOKEN_PRINT,TOKEN_RETURN,TOKEN_STRING,TOKEN_TRUE,TOKEN_VOID,TOKEN_WHILE,TOKEN_VAR,TOKEN_PROGRAM,Default
};
